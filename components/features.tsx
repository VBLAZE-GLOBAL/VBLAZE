        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Build powerful, scalable web applications with the MERN stack
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Leverage the TALL stack (Tailwind CSS, Alpine.js, Laravel,
                Livewire) to develop modern, user-friendly web applications.
              </p>
            </article>
            <article>
              <svg
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Transform your online store with powerful e-commerce platforms
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Boost your brand’s online presence with expert social media
